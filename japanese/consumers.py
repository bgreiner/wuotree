...
def subsession_model_exists():
    return 'japanese_subsession' in connection.introspection.table_names()
...
class AuctionRoom(_OTreeJsonWebsocketConsumer):
    ...
    def group_name(self, group_id, session_code):
        return "japanese_session-" + str(session_code) + "_group-" + str(group_id)
...
print("Japanese auction, active groups checking process started.....")
t = PriceUpdater()
t.daemon = True
t.start()
